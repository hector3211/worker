          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 dark:text-gray-200 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                ...
                <a href="#" className="font-semibold text-yellowprimary">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-500 sm:text-6xl">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                {user?.user.role === "admin" ? (
                  <Link href={"/dashboard"}>
                    <Button className="bg-greenprimary">Dashboard</Button>
                  </Link>
                ) : null}
                <a
                  href="#"
                  className="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-600"
                >
